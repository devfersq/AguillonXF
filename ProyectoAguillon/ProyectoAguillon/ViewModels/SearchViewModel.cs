...
namespace ProyectoAguillon.ViewModels
{
    ...
    {
        public ObservableCollection<Producto> LaListaDeProductos { get; set; } = new ObservableCollection<Producto>();

        
        public  SearchViewModel()
        {
            GetProductos().GetAwaiter();            
        }
        ...
        async Task GetProductos()
        {
            await Task.Run(() =>
            {
                LaListaDeProductos.Clear();

                LaListaDeProductos.Add(new Producto
                {
                    IdProducto = "1",
